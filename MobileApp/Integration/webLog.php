...
$text .= '<li><a href="#"><h3 style="margin:5px"> 모니터링 시간 </h3> <span style="margin-left:5px" >'.$row[isTime].'</span><span class="ui-li-count" id ="sec" style="font-size:15px; color:gray;">'.$row[takeTime].'sec </span></a></li>';
